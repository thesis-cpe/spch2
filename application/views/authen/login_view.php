...
<head>
<meta charset="utf-8"/>
<title>Authorize Access | Login Form </title>
...
<link href="<?php echo base_url();?>metronic/theme/assets/admin/pages/css/login.css" rel="stylesheet" type="text/css"/>
...
<link href="<?php echo base_url();?>metronic/theme/assets/admin/layout/css/layout.css" rel="stylesheet" type="text/css"/>
<link href="<?php echo base_url();?>metronic/theme/assets/admin/layout/css/themes/default.css" rel="stylesheet" type="text/css" id="style_color"/>
<link href="<?php echo base_url();?>metronic/theme/assets/admin/layout/css/custom.css" rel="stylesheet" type="text/css"/>
<!-- END THEME STYLES -->
...
<div class="logo">
	<a href="index.html">
	<!--<img src="<?php echo base_url();?>metronic/theme/assets/admin/layout4/img/logo-big.png" alt=""/> -->
	</a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
	...
	<form class="login-form" action="index.html" method="post">
		...
		<div class="form-actions">
			<button type="submit" class="btn blue btn-md">Login</button>
...
<div class="copyright">
	<!-- 2016 © KAN Accounting and Tax . System Name.  -->
</div>
<!-- END LOGIN -->
...
<script src="<?php echo base_url();?>metronic/theme/assets/global/plugins/jquery-validation/js/jquery.validate.min.js" type="text/javascript"></script>
<!-- END PAGE LEVEL PLUGINS -->
<!-- BEGIN PAGE LEVEL SCRIPTS -->
<script src="<?php echo base_url();?>metronic/theme/assets/global/scripts/metronic.js" type="text/javascript"></script>
<script src="<?php echo base_url();?>metronic/theme/assets/admin/layout/scripts/layout.js" type="text/javascript"></script>
<script src="<?php echo base_url();?>metronic/theme/assets/admin/layout/scripts/demo.js" type="text/javascript"></script>
<script src="<?php echo base_url();?>metronic/theme/assets/admin/pages/scripts/login.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script>
